...
func main() {
	...
	// Build file content
	var lines []string
	lines = append(lines, "// Code generated by createmap.go — DO NOT EDIT.")
	lines = append(lines, "// #nosec G101 -- This file contains only Go type-name to Terraform resource-name mappings.")
	lines = append(lines, "// Substrings such as \"ChapUser\" and \"Password\" are parts of struct/resource identifiers, not credentials.")
