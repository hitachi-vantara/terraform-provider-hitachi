...
// GetStoragePorts used to get storage ports with optional filters
func (psm *sanStorageManager) GetStoragePorts(detailInfoTypes []string, portType, portAttributes string) (*[]sanmodel.StoragePort, error) {
	...
	var provStoragePorts *[]provisonermodel.StoragePort
	provStoragePorts, err = provObj.GetStoragePorts(detailInfoTypes, portType, portAttributes)
	if err != nil {
