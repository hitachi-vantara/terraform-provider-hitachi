...
var MessageCatalog = map[interface{}]string{
	...
	INFO_UPDATE_VOLUME_NICKNAME_BEGIN:         "Updating volume name or nickname %s.",
	ERR_UPDATE_VOLUME_NICKNAME_FAILED:         "Failed to update volume name or nickname %s.",
	INFO_UPDATE_VOLUME_NICKNAME_END:           "Successfully updated volume name or nickname %s.",
