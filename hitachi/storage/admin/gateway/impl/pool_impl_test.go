...
func xTestGetAdminPoolList(t *testing.T) {
	...
	params := adminmodel.AdminPoolListParams{}
	...
	// Scenario 4: Get pools by config status filter
	...
	resp, err = psm.GetAdminPoolList(params)
	if err != nil {
		t.Errorf("Unexpected error in GetAdminPoolList (config status filter) %v", err)
		return
	}
	t.Logf("Response (filtered by config status '%s'): Count=%d, Pools=%+v", configStatus, resp.Count, resp.Data)
}
...
func xTestCreateAdminPool(t *testing.T) {
	...
	params := adminmodel.CreateAdminPoolParams{
		Name:                "test-pool-gateway-ssd",
		IsEncryptionEnabled: false,
		Drives: []adminmodel.CreateAdminPoolDrive{
			{
				DriveTypeCode:   "SSD",
				DataDriveCount:  4,
				RaidLevel:       "RAID5",
...
func xTestUpdateAdminPool(t *testing.T) {
	...
	updateParams := adminmodel.UpdateAdminPoolParams{
		Name: "updated-pool-name-gateway",
	}
...
func xTestExpandAdminPool(t *testing.T) {
	...
	expandParams := adminmodel.ExpandAdminPoolParams{
		AdditionalDrives: []adminmodel.ExpandAdminPoolDrive{
			{
				DriveTypeCode:   "SSD",
				DataDriveCount:  2,
				RaidLevel:       "RAID5",
...
func xTestDeleteAdminPool(t *testing.T) {
	...
	createParams := adminmodel.CreateAdminPoolParams{
		Name:                "test-pool-to-delete-gateway",
		IsEncryptionEnabled: false,
		Drives: []adminmodel.CreateAdminPoolDrive{
			{
				DriveTypeCode:   "SSD",
	...
	listParams := adminmodel.AdminPoolListParams{
