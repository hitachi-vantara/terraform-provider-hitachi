...
func (m *mockDiff) HasChange(key string) bool {
	if m.changes == nil {
		return false
	}
...
func TestValidateVolumeIDValues(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			id:        "100,101",
			values:    map[string]interface{}{},
			changes:   map[string]bool{"volume_id": true, "volume_id_hex": false},
			expectErr: true,
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			d := &mockDiff{id: tt.id, values: tt.values, changes: tt.changes}
...
func TestValidateNicknameParamValues(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			d := &mockDiff{values: tt.values, changes: map[string]bool{}}
...
func TestValidateDataReductionSettingsValues(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			d := &mockDiff{id: tt.id, values: tt.values, changes: map[string]bool{}}
