...
var LunInfoSchema = map[string]*schema.Schema{
	...
	"virtual_serial_number": {
		Type:        schema.TypeString,
		Computed:    true,
		Description: "Virtual storage serial number returned by the array",
	},
	"virtual_model": {
		Type:        schema.TypeString,
		Computed:    true,
		Description: "Virtual storage model returned by the array",
	},
	"clpr_id": {
		Type:        schema.TypeInt,
		Computed:    true,
	...
	"cylinder": {
		Type:        schema.TypeInt,
		Computed:    true,
		Description: "Number of cylinders on the volume",
	},
	...
	"parent_ldev_id": {
		Type:        schema.TypeInt,
		Computed:    true,
		Description: "The LDEV ID of the direct parent in the snapshot replication chain.",
	},
	"parent_ldev_id_hex": {
		Type:        schema.TypeString,
		Computed:    true,
		Description: "The LDEV ID in hex of the direct parent in the snapshot replication chain.",
	},
	"mpblade_id": {
		Type:        schema.TypeInt,
		Computed:    true,
...
var DataLunSchema = map[string]*schema.Schema{
	...
	"ldev_id_hex": {
		Type:          schema.TypeString,
		Optional:      true,
		Description:   "LDEV ID in hexadecimal format. Only one of ldev_id or ldev_id_hex may be specified, not both.",
...
var DataLunsSchema = map[string]*schema.Schema{
	...
	"start_ldev_id": &schema.Schema{
		...
		Optional:      true,
		ValidateFunc:  validation.IntBetween(0, 65535),
		Description:   "Start LDEV ID. Only one of start_ldev_id or start_ldev_id_hex may be specified, not both",
		ConflictsWith: []string{"start_ldev_id_hex"},
	},
	"start_ldev_id_hex": {
		Type:          schema.TypeString,
		Optional:      true,
		Description:   "Start LDEV ID in hexadecimal format. Only one of start_ldev_id or start_ldev_id_hex may be specified, not both.",
	...
	"end_ldev_id": &schema.Schema{
		...
		ConflictsWith: []string{"end_ldev_id_hex"},
	},
	"end_ldev_id_hex": {
		Type:          schema.TypeString,
		Optional:      true,
		Description:   "End LDEV ID in hexadecimal format. Only one of end_ldev_id or end_ldev_id_hex may be specified, not both.",
	...
	"filter_option": &schema.Schema{
		Type:        schema.TypeString,
		Optional:    true,
		Description: "LDEV conditions for getting information. Values: defined, undefined, dpVolume, luMapped, luUnmapped, externalVolume, mappedNamespace, mainframe",
		ValidateFunc: validation.StringInSlice([]string{
			"defined", "undefined", "dpVolume", "luMapped", "luUnmapped", "externalVolume", "mappedNamespace", "mainframe",
		}, true),
	},
	"include_detail_info": &schema.Schema{
		...
		Optional:    true,
		Default:     false,
		Description: "Include detailed information for storage volumes. When set to true, additional detailed fields will be populated.",
	},
...
var ResourceLunSchema = map[string]*schema.Schema{
	...
	// Mainframe-specific inputs
	"cylinder": {
		Type:         schema.TypeInt,
		Optional:     true,
		Description:  "Mainframe only: Capacity of the volume to be created in cylinders.",
		ValidateFunc: validation.IntAtLeast(1),
	},
	"emulation_type": {
		Type:        schema.TypeString,
		Optional:    true,
		Description: "Emulation type. Allowed values: OPEN-V, 3390-A, 3390-V (case-insensitive).",
		ValidateFunc: validation.StringInSlice([]string{
			"OPEN-V",
			"3390-A",
			"3390-V",
	...
	"clpr_id": {
		Type:         schema.TypeInt,
		Optional:     true,
		Description:  "CLPR number to which the virtual volume belongs.",
		ValidateFunc: validation.IntAtLeast(0),
	},
	"mp_blade_id": {
		Type:         schema.TypeInt,
		Optional:     true,
		Description:  "MP blade ID (0-15).",
	...
	// Post-create formatting action (input). Default is NONE (no-op).
	"volume_format_type": {
		Type:        schema.TypeString,
		Optional:    true,
		Default:     "NONE",
