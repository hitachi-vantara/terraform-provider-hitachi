...
type StoragePortsVssb struct {
	Data []StoragePortVssb `json:"data"`
}

type PortWithAuthSettings struct {
	Port         StoragePortVssb  `json:"storagePort"`
