...
- `compute_node_name` (String) Compute node nickname (required for create/update; used for import/read by name)
...
- `vosb_address` (String) The host name or the IP address (IPv4) of VSP One SDS Block. Required for create/update and import.
