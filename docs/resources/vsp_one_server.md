...
- `serial` (Number) Serial number of storage system. Required for create/update and import.
- `server_nickname` (String) Server nickname. Required for create/update; optional for import.
...
- `total_capacity_in_mib` (Number) Total assigned volume capacity (MiB).
- `used_capacity_in_mib` (Number) Volume usage (assigned capacity) (MiB).
