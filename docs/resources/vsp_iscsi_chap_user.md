...
- `chap_user_name` (String) CHAP user name. Required for create/update; optional for import.
...
- `iscsi_target_number` (Number) Target ID of the iSCSI target. Required for create/update and import.
- `port_id` (String) Port number. Required for create/update and import.
