...
23. [Privacy Notice](#privacy-notice)
24. [License](#license)
...
**Schema**
**hitachi_vosb_provider**
  (block list) VSP One SDS Block and Cloud is a system that builds and sets up a virtual
storage system from multiple general-purpose servers. The system offers a high-performance,
high-capacity block storage service with high reliability.
...
**san_storage_system**
 (block list) VSP One Block, VSP 5000 series, VSP E series, VSP F series, and VSP G
series - all the VSP block storage systems present in the Hardware requirements 
table are enterprise and/or mid-range storage solutions designed to provide
reliable and scalable block storage for a variety of environments. Both systems focus
...
|-------------------------------------|--------------------------|
| Bare Metal | 01.18.01.40 |
| Cloud for AWS | 01.18.01.30 |
| Cloud for Microsoft Azure | 01.18.01.50 |
| Cloud for GCP | 01.18.01.60 |
...
| Category | Details |
|----------|---------|
| Software | Terraform - version 1.11.3 or higher |
