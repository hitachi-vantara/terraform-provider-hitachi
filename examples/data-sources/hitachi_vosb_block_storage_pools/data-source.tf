...
#
# The data source block "hitachi_vosb_block_storage_pools" retrieves details about storage pools
...
#
# Customize the values of the parameters (vosb_block_address, storage_pool_names) to match your
...
output "pool" {
  value = data.hitachi_vosb_block_storage_pools.pool
}
