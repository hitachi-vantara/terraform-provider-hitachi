resource "hitachi_vosb_iscsi_chap_user" "my_chap_user10" {
...
output "chap_user_output2" {
  value = resource.hitachi_vosb_iscsi_chap_user.my_chap_user10
}

resource "hitachi_vosb_iscsi_chap_user" "my_chap_user9" {
  vosb_address       = "10.76.47.55"
...
output "chap_user_output" {
  value = resource.hitachi_vosb_iscsi_chap_user.my_chap_user9
}
