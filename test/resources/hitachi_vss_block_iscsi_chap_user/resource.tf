resource "hitachi_vss_block_iscsi_chap_user" "my_chap_user10" {
...
output "chap_user_output2" {
  value = resource.hitachi_vss_block_iscsi_chap_user.my_chap_user10
}

resource "hitachi_vss_block_iscsi_chap_user" "my_chap_user9" {
  vss_block_address       = "10.76.47.55"
...
output "chap_user_output" {
  value = resource.hitachi_vss_block_iscsi_chap_user.my_chap_user9
}
